...
{
    public class DetailedServiceUnit : IMapper<Models.Stockholm.Place.DetailedServiceUnit, Models.JSON.Stockholm.DetailedServiceUnit.RootObject>
    {

        public System.Collections.Generic.IEnumerable<Models.Stockholm.Place.DetailedServiceUnit> JSON2Model(Models.JSON.Stockholm.DetailedServiceUnit.RootObject root)
        {
            throw new NotImplementedException();
        }

        public System.Collections.Generic.IEnumerable<Models.Stockholm.Place.DetailedServiceUnit> JSON2Model(System.Collections.Generic.IEnumerable<Models.JSON.Stockholm.DetailedServiceUnit.RootObject> root)
        {
            throw new NotImplementedException();
        }

        public Models.Stockholm.Place.DetailedServiceUnit JSON2FirstModel(Models.JSON.Stockholm.DetailedServiceUnit.RootObject root)
        {
            ...
            return new Models.Stockholm.Place.DetailedServiceUnit()
            {
                Content = root.Name,
                ID = root.Id,
        ...
        public Models.Stockholm.Place.DetailedServiceUnit JSON2LastModel(Models.JSON.Stockholm.DetailedServiceUnit.RootObject root)
        {
            throw new NotImplementedException();
        }
