...
namespace Usoniandream.WindowsPhone.LocationServices.Extensions
{
    public static class ObservableExtensions
    {
        ...
        {
            Action<IRestRequest, Action<RestResponse>> callback = (r, a) => client.ExecuteAsync(r, a);
        ...
        {
            Action<IRestRequest, Action<RestResponse<T>>> callback = (r, a) => client.ExecuteAsync(r, a);
